...
_PACKAGE_DIR = _PROJECT_ROOT / "src" / "openjev"


@pytest.fixture(scope="session")
def evaluable() -> EvaluableArchitecture:
    """Build the evaluable architecture graph for openjev.

    Uses openjev package as both root and module path
    so module names resolve cleanly (e.g. 'openjev.module').
    """
